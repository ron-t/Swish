...
app.use('/js/lib', express.static(path.join(__dirname, 'node_modules/xlsx/dist'), { maxAge: 31557600000 }));
app.use('/webfonts', express.static(path.join(__dirname, 'node_modules/material-icons'), { maxAge: 31557600000 }));
...
app.post('/upload', homeController.postUpload);
